...
const benefits = [
    ...
    },
    {
        ...
        desc: "Covering the full spectrum of professional development needs across various fields.",
        icon: BookOpen01Icon,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="text-slate-500 font-normal text-base leading-relaxed space-y-4">
                            <p>
                                As the Training, Research and Development Unit of the University of Ibadan's ICT centre, we build real and verifiable competencies.
                            </p>
                            <p>
                                Our structured learning experiences are expertly designed for university staff, students, and professionals seeking practical skills backed by institutional credibility.
                            </p>
                        </div>
                        <Link to="/signup">
                    ...
                    <div className="w-full relative px-0.5">
                        <style>
                            {`
                                .trd-swiper .swiper-pagination {
                                    position: relative;
                                    margin-top: 2rem;
                                }
                                .trd-swiper .swiper-pagination-bullet {
                                    background: #cbd5e1;
                                    opacity: 1;
                                }
                                .trd-swiper .swiper-pagination-bullet-active {
                                    background: #2563eb;
                                }
                            `}
                        </style>
